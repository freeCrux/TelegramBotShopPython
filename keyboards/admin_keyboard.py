...
show_addresses_button = KeyboardButton("/show_addresses")
add_address_button = KeyboardButton("/add_address")
...
admin_menu_kb.row(add_address_button, show_addresses_button)
